...
export function BookSummaryPanel({
  ...
  return (
    <div className="space-y-4">
      {/* Book Summary */}
      <div className="rounded-xl border border-blue-100 dark:border-blue-800/50 bg-blue-50/40 dark:bg-blue-900/10 p-5">
        <div className="mb-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <h2 className="text-sm font-semibold text-blue-800 dark:text-blue-300">Book Summary</h2>
            {summaryModel && (
              <span className="rounded-full bg-blue-100 dark:bg-blue-900/50 px-1.5 py-0 text-[9px] font-semibold uppercase text-blue-600 dark:text-blue-400 ring-1 ring-inset ring-blue-200 dark:ring-blue-700">
                AI · {summaryModel}
              </span>
            )}
            {summaryAt && (
          ...
          {isAuthenticated && (
            <button
              ...
              disabled={generating}
              className="flex items-center gap-1 rounded-lg border border-blue-300 dark:border-blue-700 bg-white dark:bg-gray-900 px-2.5 py-1 text-xs font-medium text-blue-700 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-gray-800 disabled:opacity-50"
            >
              {generating ? (
                <>
        ...
        {summary ? (
          <details open={expanded} onToggle={(e) => setExpanded((e.target as HTMLDetailsElement).open)}>
            <summary className="flex cursor-pointer list-none items-center gap-1.5 text-sm font-medium text-blue-800 dark:text-blue-300 hover:text-blue-900 dark:hover:text-blue-200">
              <svg
            ...
            <div className="mt-3 space-y-3">
              ...
              {summary.structure && (
                <p className="text-xs leading-relaxed text-gray-600 dark:text-gray-400">
                  <span className="font-semibold text-gray-700 dark:text-gray-300">Structure:</span> {summary.structure}
                </p>
              )}
              {summary.manuscript_tradition && (
                <p className="text-xs leading-relaxed text-gray-600 dark:text-gray-400">
                  <span className="font-semibold text-gray-700 dark:text-gray-300">Manuscript tradition:</span> {summary.manuscript_tradition}
                </p>
              )}
              {summary.scholarly_significance && (
                <p className="text-xs leading-relaxed text-gray-600 dark:text-gray-400">
                  <span className="font-semibold text-gray-700 dark:text-gray-300">Significance:</span> {summary.scholarly_significance}
                </p>
              )}
      ...
      {isAuthenticated && unsummarizedChapters.length > 0 && (
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 p-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Chapter summaries</p>
            ...
            {chapterPhase === "idle" && (
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 px-3 py-1.5 text-xs font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800"
              >
                <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.455 2.456L21.75 6l-1.036.259a3.375 3.375 0 0 0-2.455 2.456Z" />
                </svg>
              ...
              <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-3">
                ...
                <div className="mt-2 flex gap-2">
                  <button
                    ...
                    className="rounded-md bg-gray-800 dark:bg-gray-700 px-3 py-1 text-xs font-medium text-white hover:bg-gray-900 dark:hover:bg-gray-600"
                  >
                    Confirm
                  </button>
                  <button
                    onClick={() => setChapterPhase("idle")}
                    className="rounded-md border border-gray-300 dark:border-gray-600 px-3 py-1 text-xs font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800"
                  >
                    Cancel
                  </button>
                </div>
